 ...
 *
 * Trazida do projeto da Lennys, onde já foi auditada.
 *
 * Foto de celular vem com 4 a 8 MB. Enviar isso cru gastaria a franquia de
 * Storage, deixaria o cadastro lento no 4G da oficina e depois obrigaria o
 ...
 * Safari devolve `null` no `toBlob` com webp. O resultado, lá, foi um PNG de
 * 3,8 MB subindo com nome `.webp` e `Content-Type: image/webp`.
 *
 * Por isso agora:
...
/**
 * Teto de pixels. Maior que o da Lennys: escultura se vende no detalhe (o
 * veio, o corte do formão), e o zoom do visor precisa de onde tirar.
 */
export const PIXELS_MAXIMOS = 2200 * 2200
